        ...
        <div class="col">
            <div class="card mb-4 rounded-3 shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <a href="/subscription/starter/monthly" type="button" class="w-100 btn btn-lg btn-outline-primary">Choisir</a>
                </div>
            </div>
        </div>
        <div class="col">
            <div class="card mb-4 rounded-3 shadow-sm border-primary">
                ...
                <div class="card-body">
                    ...
                    <a href="/subscription/starter/yearly" type="button" class="w-100 btn btn-lg btn-primary">Choisir</a>
                </div>
            </div>
        </div>
    </div>
