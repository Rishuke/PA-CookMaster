<main>
    ...
    <div class="col-md-9 mt-4" style="margin: 0 auto;">
                ...
                <tr>
                    ...
                    <th scope="col" style="width: 25%;">
                        ...
                        <p class="text-center d-flex flex-column align-items-center">
                            <img src="https://cookorama.fr/ressources/images/pricingIcon/free.png" alt="Free" class="img-fluid">
                            <span>Free
                                <!-- <span class="badge text-bg-success ms-2">Abonnement actuel</span> -->
                            </span>
                        </p>
                    ...
                    <th scope="col" style="width: 25%;">
                        ...
                        <p class="text-center d-flex flex-column align-items-center">
                            <img src="https://cookorama.fr/ressources/images/pricingIcon/starter.png" alt="Starter" class="img-fluid">
                            <span>Starter</span>
                        </p>

                        <p style="font-size: 13px;">
                            <em>9.90 €/mois ou 113.00 €/an</em>
                            <a class="book-a-table-btn scrollto btn ms-1" id="choosePlan" href="/subscription/starter">Choisir cet abonnement</a>
                        </p>
                    ...
                    <th scope="col" style="width: 25%;">
                        ...
                        <p class="text-center d-flex flex-column align-items-center">
                            <img src="https://cookorama.fr/ressources/images/pricingIcon/master.png" alt="Master" class="img-fluid">
                            <span>Master</span>
                        </p>

                        <p style="font-size: 13px;">
                            <em>19.00 €/mois ou 220.00 €/an</em>
                            <a class="book-a-table-btn scrollto btn ms-1" id="choosePlan" href="/subscription/master">Choisir cet abonnement</a>
                        </p>
        ...
        <p><strong>*</strong> Hors formule <strong><em>Free</em></strong><span><img src="https://cookorama.fr/ressources/images/pricingIcon/free.png" alt="Free" width="50"></span></p>
